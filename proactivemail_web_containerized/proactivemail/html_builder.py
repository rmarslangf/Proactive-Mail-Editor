...
def build_html(subject, blocks,
               header_image_path=None, header_b64=None,
               header_bg="#1B3A5C", header_text_color="#ffffff",
               footer_text="", footer_image_path=None, footer_b64=None,
    ...
    # Web: header_b64 (data URI) | Masaüstü: header_image_path
    _hdr_src = (header_b64
                if header_b64
                else img_to_b64(header_image_path)
                if header_image_path and os.path.exists(header_image_path)
                else None)
    if _hdr_src:
        header_html = (
            f'<img src="{_hdr_src}" alt="Header"'
    ...
    _ftr_src = (footer_b64
                if footer_b64
                else img_to_b64(footer_image_path)
