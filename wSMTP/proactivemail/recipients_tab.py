...
Özellikler:
  - Grup listesi (renk kodlu) + grup ekle/düzenle/sil
  - Alıcı tablosu: ad, email, şirket, grup, durum, abonelik
  - Alıcı ekle / düzenle / sil (soft delete)
  - Abonelik iptal / yeniden abone
  - CSV içe aktar
  - Arama / filtre (grup + abonelik durumu)
"""
